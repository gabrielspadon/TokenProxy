// Explicit source and dependency closure used by restricted compatibility workers.
export const COMPATIBILITY_WORKER_FILES = [
  ...
  "./open-sse/handlers/chatCore/upstreamRoute.js",
  ...
  "./open-sse/services/tokenRefresh/credentialRevision.js",
  ...
  "./open-sse/utils/preparationAbort.js",
  ...
  "./package.json",
  "./src/lib/compatibility/controlled.mjs",
  "./src/lib/compatibility/evidence.mjs",
  "./src/lib/compatibility/model.mjs",
  "./src/lib/compatibility/runner.mjs",
  "./src/lib/compatibility/runtimeFiles.mjs",
  "./src/lib/compatibility/version.mjs",
