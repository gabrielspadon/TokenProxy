...
const SAVERS = new Set(["rtk", "headroom", "pxpipe", "inject", "mem", "schema", "privacy", "thinking", "qac", "pairs", "diet", "lingua", "reorder", "midinject", "tools", "epochMicro", "epochAuto"]);
// Bounded reason enum — only vetted labels, never free-form diagnostics text.
const REASONS = new Set(["phantom", "epoch_boundary", "window_pressure", "no_backend"]);
