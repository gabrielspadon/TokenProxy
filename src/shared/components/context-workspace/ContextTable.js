...
export function ContextTable({ columns, rows, label, selectedId, minWidth = 780 }) {
  ...
  return <Table.ScrollContainer minWidth={minWidth} type="native" className={styles.tableScroll} tabIndex={0} role="region" aria-label={`${label}, scroll horizontally for all columns`}>
