...
export const workspaceTheme = createTheme({
  ...
  fontSizes: { xs: '.75rem', sm: '.8125rem', md: '.8125rem', lg: '.9375rem', xl: '1.125rem' },
  ...
  headings: {
    ...
    sizes: { h1: { fontSize: '1.375rem', lineHeight: '1.2' }, h2: { fontSize: '1.0625rem', lineHeight: '1.4' }, h3: { fontSize: '.9375rem', lineHeight: '1.4' } },
  },
  colors: {
  ...
  components: {
    ...
    ActionIcon: { defaultProps: { size: 30, variant: 'subtle' } },
    ...
    Table: { defaultProps: { verticalSpacing: 4, horizontalSpacing: 8 } },
  },
});
