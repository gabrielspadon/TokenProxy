...
const theme = createTheme({
  primaryColor: 'indigo', primaryShade: 7, defaultRadius: 'sm',
  ...
  colors: { indigo: ['#f0f2ff','#e2e7ff','#c6cefa','#a6b3ef','#8797e4','#6c7ed8','#566acd','#455bca','#354bb5','#2b3e97'] },
  components: {
...
export function UiProvider({ children }) {
  return <MantineProvider theme={theme} forceColorScheme="light"><Notifications position="bottom-right" />{children}</MantineProvider>;
}
