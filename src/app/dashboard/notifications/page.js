...
export default function NotificationsPage() {
  ...
  return (
    <>
      ...
      <section aria-labelledby="h-sending" data-task-panel hidden={task !== 'overview'}>
        <h2 id="h-sending">
      ...
      <section aria-labelledby="h-where" data-task-panel hidden={task !== 'destinations'}>
        <h2 id="h-where">
          <Icon name="i-send" />
          Where they go
        </h2>
      ...
      <section aria-labelledby="h-rate" data-task-panel hidden={task !== 'rules'}>
        <h2 id="h-rate">
          <Icon name="i-alert" />
      ...
      <section aria-labelledby="h-log" data-task-panel hidden={task !== 'overview'}>
      ...
      <section aria-labelledby="h-rules" data-task-panel hidden={task !== 'rules'}>
