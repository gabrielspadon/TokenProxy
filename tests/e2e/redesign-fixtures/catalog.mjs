...
export const MUTATIONS = Object.freeze(['investigations', 'configuration drafts and scoped activation', 'synthetic account policy and drain', 'access profiles and local keys', 'model policy', 'notification rules', 'local translation and compatibility', 'shaping controls/plans/runtime settings', 'pricing overrides', 'synthetic budget reconciliation', 'declarative custom adapter', 'partial proxy-pool deletion']);
